var QNover = {
	...
	openQNFloat : function(aText) {
	 ...
	 for(var i=0;i < gBrowser.browsers.length;i++) {
		 if (typeof gBrowser.browsers[i].contentDocument !== 'null') {
		...
		window.parent.addEventListener("close", function() {if(QN_globalvar.qnprefs.getBoolPref("closechild")){if(QNover.getQNWinByType("quicknote:mainwindow")!=null){QNover.getQNWinByType("quicknote:mainwindow").close()}}}, false);
	 }
	},
	...
	try {
		...
		var addon = em.getItemForID("{C0CB8BA3-6C1B-47e8-A6AB-1FAB889562D9}");
			document.getElementById("vernumb").value = addon.version;
	 }
	}
};
